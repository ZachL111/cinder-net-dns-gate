"""Regression checks for the cinder-net-dns-gate casebook."""
...
from casebook.harness import assert_expected, cinder_net_dns_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cinder_net_dns_gate_summary(), assert_expected())
